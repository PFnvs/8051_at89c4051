M:main
F:G$show_dig$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$timer0$0_0$0({2}DF,SV:S),C,0,0,1,1,0
F:G$timer1$0_0$0({2}DF,SV:S),C,0,0,1,3,0
F:G$delay$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$delayms$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:G$PWM$0_0$0({2}SI:U),E,0,0
S:G$count_prg$0_0$0({1}SC:U),E,0,0
S:G$dig1$0_0$0({1}SC:U),E,0,0
S:G$dig2$0_0$0({1}SC:U),E,0,0
S:G$dig3$0_0$0({1}SC:U),E,0,0
S:G$power$0_0$0({1}SC:U),E,0,0
S:G$key_enable$0_0$0({1}SC:U),E,0,0
...
S:G$show_dig$0_0$0({2}DF,SV:S),C,0,0
S:G$timer0$0_0$0({2}DF,SV:S),C,0,0
S:G$timer1$0_0$0({2}DF,SV:S),C,0,0
S:G$delay$0_0$0({2}DF,SV:S),C,0,0
S:G$delayms$0_0$0({2}DF,SV:S),C,0,0
S:G$main$0_0$0({2}DF,SV:S),C,0,0
S:G$table$0_0$0({10}DA10d,SC:U),D,0,0
